...
class Historicodeeventos(models.Model):
    ...
    posicao = models.CharField(max_length=255, blank=True, null=True)
    ...
    esis_desc_tratamento = models.CharField(max_length=255, blank=True, null=True)
    ...
    alertasinal = models.IntegerField(max_length=1, default=0)
    acionamentoPamcary = models.IntegerField(max_length=1, default=0)
    email = models.CharField(max_length=1, default='N')
    acionamentoPR = models.IntegerField(max_length=1, default=0)
